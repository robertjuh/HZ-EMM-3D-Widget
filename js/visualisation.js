 ...
 */
		...
		//controls, copied from other files
...
$(document).ready(function() {
	...
	*/	
	function initialiseTHREEComponents(){
		...
		tekenTestBolletjeInMid();					
//	ajaxCall();

	}
	
	function tekenTestBolletjeInMid(){
		var controls = new THREE.OrbitControls(camera);
		camera.updateProjectionMatrix();
		//create the sphere
		var bolletje = new THREE.Mesh(new THREE.SphereGeometry(45, 54, 22), new THREE.MeshPhongMaterial({color : "green"}));

		scene.add(bolletje);
		
		bolletje.position.set(44,44,44);
		
		createCallbackFunctionForSphere(bolletje);	
