...
$(document).ready(function() {
	...
	function initialiseTHREEComponents(){
		...
		visualize2(stringCurrentConcept, 1, "true,true");
	}
...
//	else
	...
	function visualize2(concept, depth, relations) {
		console.log("visualize2 met volgende 3 PARAMERTERS:")
		console.log(concept);
		console.log(depth);
		...
		console.log(relations);				
			...
			//			scene.add(axisHelper);
					...
					scene.add(sphere);
						...
						console.log(scene);
						//debugger;
						//console.log("scene.children before en after");																	
						//console.log(scene.children);
								for( var i = scene.children.length - 1; i >= 0; i--) {
									console.log("scene.children[i] die ik ga verwijderen"); 
