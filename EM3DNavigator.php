...
$wgResourceModules['ext.EM3DNavigator'] = array(
	'scripts' =>  array('js/jquery-2.1.1.min.js', 'js/jquery.cookie.js', 'js/bootstrap.min.js', 'js/cola.min.js', 'js/three.min.js', 'js/d3.v3.js',  'js/default.js',  'js/OrbitControls.js', 'js/OrthographicTrackballControls.js', 'js/TrackballControls.js', 'js/visualisation.js', 'js/slider.js', 'js/visualisationJsModule.js', 'js/JSONStyleSheet.js'),
