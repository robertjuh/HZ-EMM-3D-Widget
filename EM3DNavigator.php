...
$wgResourceModules['ext.EM3DNavigator'] = array(
	'scripts' =>  array('js/jquery.makeCollapsible.js', 'js/jquery-2.1.1.min.js', 'js/three.min.js', 'js/jquery.cookie.js', 'js/d3.v3.js', 'js/tween.js',  'js/default.js',  'js/OrbitControls.js', 'js/visualisation.js', 'js/slider.js', 'js/visualisationJsModule.js'),
	'styles' => array ('css/navigatorStyle.css'),
